...
public class WindowManager {
    ...
    public void init() {
        ...
        if(!GLFW.glfwInit()) {
            throw new IllegalArgumentException("Unable to init");
        }
    ...
    public boolean isRezize() {
        return rezize;
    }

    public void setRezize(boolean rezize) {
        this.rezize = rezize;
    }
